...
def main():
    ...
    bank=build_profile_bank_v7(list(train.get('records',[])), class_names=list(schema.class_names), part_names=list(schema.part_names), score_tau=0.05, required_tau=0.35, min_relation_support=6, uniform_prior=True)
